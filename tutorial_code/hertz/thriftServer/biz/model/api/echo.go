...
func (p *EchoClient) Echo(ctx context.Context, req *EchoReq) (r *EchoResp, err error) {
...
func (p *EchoEchoArgs) GetReq() (v *EchoReq) {
	if !p.IsSetReq() {
...
var EchoEchoResult_Success_DEFAULT *EchoResp

func (p *EchoEchoResult) GetSuccess() (v *EchoResp) {
	if !p.IsSetSuccess() {
